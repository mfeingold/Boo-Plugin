...
namespace BooProject_IntegrationTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        public void LaunchCommand()
        {
            ...
            {
                CommandID menuItemCmd = new CommandID(Hill30.BooProject.GuidList.guidBooProjectCmdSet, (int)Hill30.BooProject.PkgCmdIDList.cmdidMyCommand);
